...
int main(void)
{
	...
	song.add(new SongItem(new Tone(C, 1)));
	song.add(new SongItem(new Tone(D, 1)));
	song.add(new SongItem(new Tone(E, 1)));
	song.add(new SongItem(new Tone(F, 1)));
	song.add(new SongItem(new Tone(G, 1)));
	song.add(new SongItem(new Tone(G, 1)));
	song.add(new SongItem(new Tone(A, 1)));
	song.add(new SongItem(new Tone(A, 1)));
	song.add(new SongItem(new Tone(A, 1)));
	song.add(new SongItem(new Tone(A, 1)));
	song.add(new SongItem(new Tone(G, 1)));
